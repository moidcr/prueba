...
<?php $usercanprice = $user->rights->sin_precio->myobject->price;
$hide_price = "";
if(isset($user->rights->sin_precio->myobject->price) && $usercanprice==1){
	$hide_price = "hidden";
}?>

	<td <?php echo $hide_price;?> class="linecoluht nowrap right"><?php $coldisplay++; ?><?php print price($sign * $line->subprice); ?></td>
...
<?php } else {
	print '<td '.$hide_price.' class="linecolht nowrap right">';
	$coldisplay++;
