...
// Price HT
print '<td '.$hide_price.' class="linecoluht right" style="width: 80px">'.$langs->trans('PriceUHT').'</td>';
...
// Total HT
print '<td '.$hide_price.' class="linecolht right">'.$langs->trans('TotalHTShort').'</td>';
