...
class modNumberseries extends DolibarrModules
{
    ...
    public function init($options = '')
    {
        ...
        $param['options'][$quer] = '';
        $extra->addExtraField("serie", "Número de serie", "sellist", 1, "", "facture", 0, 0, "", $param);

        $param = array();
        $quer = 'numberseries:ref:rowid:: typedoc = 2 AND entity = ' . $conf->entity;
        $param['options'][$quer] = '';
        $extra->addExtraField("serie", "Número de serie", "sellist", 1, "", "facture_fourn", 0, 0, "", $param);

        $param = array();
        $quer = 'numberseries:ref:rowid:: typedoc = 3 AND entity = ' . $conf->entity;
        $param['options'][$quer] = '';
        $extra->addExtraField("serie", "Número de serie", "sellist", 1, "", "commande", 0, 0, "", $param);

        $param = array();
        $quer = 'numberseries:ref:rowid:: typedoc = 4 AND entity = ' . $conf->entity;
        $param['options'][$quer] = '';
        $extra->addExtraField("serie", "Número de serie", "sellist", 1, "", "commande_fournisseur", 0, 0, "", $param);

        $param = array();
        $quer = 'numberseries:ref:rowid:: typedoc = 5 AND entity = ' . $conf->entity;
        $param['options'][$quer] = '';
        $extra->addExtraField("serie", "Número de serie", "sellist", 1, "", "propal", 0, 0, "", $param);
